                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="testimonial-author-box">
                                    <img
                                        src="{{ asset('img/mini-testimonial-1.jpg') }}"
                                        alt=""
                    ...
                    <div class="testimonials-box">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="testimonial-author-box">
                                    <img
                                        src="{{ asset('img/mini-testimonial-2.jpg') }}"
                                        alt=""
                                        class="testimonial-avatar"
                                    >
