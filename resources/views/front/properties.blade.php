                ...
                <div class="col-lg-8 col-md-12 blog-pots">
                        ...
                        <div class="pro-wrapper">
                            ...
                            <div class="cod-pad single detail-wrapper mr-2 mt-0 d-flex justify-content-md-end align-items-center grid">
                                ...
                                <div class="sorting-options">
                                    ...
                                    <a
                                        href="properties-grid-1.html"
                                        class="change-view-btn lde"
                    ...
                    <div class="row featured portfolio-items">
                        <div class="item col-lg-5 col-md-12 col-xs-12 landscapes sale pr-0 pb-0">
                            <div
                                class="project-single mb-0 bb-0"
                                data-aos="fade-up"
                            >
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        >
                                            ...
                                            <img
                                                src="{{ asset('images/blog/b-11.jpg') }}"
                                                alt="home-1"
                        ...
                        <!-- homes content -->
                        <div
                            class="col-lg-7 col-md-12 homes-content pb-0 mb-44"
                            data-aos="fade-up"
                        >
                            <!-- homes address -->
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-1.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > Lisa Jhonson
                                </a>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        >
                                            ...
                                            <img
                                                src="{{ asset('images/blog/b-12.jpg') }}"
                                                alt="home-1"
                                                class="img-responsive"
                                            >
                                        </a>
                        ...
                        <!-- homes content -->
                        <div
                            class="col-lg-7 col-md-12 homes-content pb-0 my-44 ft mb-44"
                            data-aos="fade-up"
                        >
                            <!-- homes address -->
                            <h3><a href="single-property-1.html">Real House Luxury Villa</a></h3>
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-2.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > Karl Smith
                                </a>
                        ...
                        >
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-3.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > katy Teddy
                                </a>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        >
                                            ...
                                            <div class="homes-price">$300</div>
                                            <img
                                                src="{{ asset('images/feature-properties/fp-10.jpg') }}"
                                                alt="home-1"
                                                class="img-responsive"
                                            >
                                        </a>
                        ...
                        >
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-4.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > Jhon Malon
                                </a>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        >
                                            ...
                                            <div class="homes-price">$900</div>
                                            <img
                                                src="{{ asset('images/feature-properties/fp-11.jpg') }}"
                                                alt="home-1"
                                                class="img-responsive"
                                            >
                                        </a>
                        ...
                        >
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-5.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > Susan Delman
                                </a>
                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        ...
                                        >
                                            ...
                                            <div class="homes-price">$300</div>
                                            <img
                                                src="{{ asset('images/feature-properties/fp-12.jpg') }}"
                                                alt="home-1"
                                                class="img-responsive"
                                            >
                                        </a>
                        ...
                        <!-- homes content -->
                        <div
                            class="col-lg-7 col-md-12 homes-content pb-0 my-44 mb-44 ft"
                            data-aos="fade-up"
                        >
                            <!-- homes address -->
                            <h3><a href="single-property-1.html">Real House Luxury Villa</a></h3>
                            ...
                            <div class="footer">
                                <a href="agent-details.html">
                                    <img
                                        src="{{ asset('images/testimonials/ts-6.jpg') }}"
                                        alt=""
                                        class="mr-2"
                                    > Chan Lee
                                </a>
                        ...
                        <!-- homes content -->
                        <div
                            class="col-lg-7 col-md-12 homes-content pb-0 mb-0"
                            data-aos="fade-up"
                        >
                            <!-- homes address -->
                            <h3><a href="single-property-1.html">Real House Luxury Villa</a></h3>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-1.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-2.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-3.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-4.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-5.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
                                    ...
                                    <div class="agents-grid mr-0">
                                        <div class="listing-item compact">
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{ asset('images/feature-properties/fp-6.jpg') }}"
                                                    alt=""
                                                >
                                            </a>
                                        </div>
