                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="listing_single_description">
                                ...
                                <p class="gpara second_para white_goverlay mt10 mb10">Fully furnished. Elegantly appointed condominium unit situated on premier location. PS6. The wide entry hall leads to a large living room with dining area. This expansive 2 bedroom and 2 renovated marble
                                    bathroom apartment has great windows. Despite the interior views, the apartments Southern and Eastern exposures allow for lovely natural light to fill every room. The master suite is surrounded by handcrafted milkwork and features incredible walk-in closet and
                                    storage space.</p>
                                <div
                                    class="collapse"
                                    id="collapseExample"
                                >
                                    <div class="card card-body">
                                        <p class="mt10 mb10">Fully furnished. Elegantly appointed condominium unit situated on premier location. PS6. The wide entry hall leads to a large living room with dining area. This expansive 2 bedroom and 2 renovated marble bathroom apartment has great
                                            windows. Despite the interior views, the apartments Southern and Eastern exposures allow for lovely natural light to fill every room. The master suite is surrounded by handcrafted milkwork and features incredible walk-in closet and storage space.</p>
                                        <p class="mt10 mb10">Fully furnished. Elegantly appointed condominium unit situated on premier location. PS6. The wide entry hall leads to a large living room with dining area. This expansive 2 bedroom and 2 renovated marble bathroom apartment has great
                                            windows. Despite the interior views, the apartments Southern and Eastern exposures allow for lovely natural light to fill every room. The master suite is surrounded by handcrafted milkwork and features incredible walk-in closet and storage space.</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="card floor_plan">
                                            ...
                                            >
                                                <div class="card-body text-center">
                                                    <img
                                                        class="img-fluid"
                                                        src="{{ asset('images/resource/floor_plan.png') }}"
                                                        alt="floor_plan.png"
                                                    >
                                                    <p>Plan description. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit
                                        ...
                                        <div class="property_video">
                                            <div class="thumb">
                                                <img
                                                    ...
                                                    src="{{ asset('images/background/7.jpg') }}"
                                                    alt="7.jpg"
                                                >
                                                <div class="overlay_icon">
                                                    <a
                        ...
                        <div class="col-lg-12">
                            <div class="walkscore_area mt30">
                                <h4 class="mb30">Walkscore <span class="float-right"><img
                                            src="{{ asset('images/resource/wscore.png') }}"
                                            alt="wscore.png"
                                        ></span></h4>
                        ...
                        <div class="col-lg-12">
                            <div class="product_single_content">
                                <div class="mbp_pagination_comments mt30">
                                    ...
                                    <div class="mbp_first media">
                                        <img
                                            src="{{ asset('images/testimonial/2.png') }}"
                                            class="mr-3"
                                            alt="2.png"
                                        >
                                        <div class="media-body">
                                    ...
                                    <div class="mbp_comment_form style2">
                                        ...
                                        <form class="comments_form">
                                            ...
                                            <button
                                                type="submit"
                                                class="btn btn-thm"
                                            >Submit Review <span class="flaticon-right-arrow-1"></span></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="sasw_list mb0">
                                ...
                                <li>
                                    <div class="small_dropdown2">
                                        ...
                                        >
                                            <span>Price</span>
                                            <label for="exampleInputEmail22"><span class="fa fa-angle-down"></span></label>
                                        </div>
                            ...
                            <div class="item">
                                <div class="feat_property home7 agent">
                                    <div class="thumb">
                                        <img
                                            class="img-whp"
                                            src="{{ asset('images/property/fp4.jpg') }}"
                                            alt="fp4.jpg"
                                        >
                                        <div class="thmb_cntnt">
                                            <ul class="tag mb0">
                            ...
                            <div class="item">
                                <div class="feat_property home7 agent">
                                    <div class="thumb">
                                        <img
                                            class="img-whp"
                                            src="{{ asset('images/property/fp5.jpg') }}"
                                            alt="fp5.jpg"
                                        >
                                        <div class="thmb_cntnt">
                                            <ul class="tag mb0">
                    ...
                    <div class="sidebar_feature_listing">
                        ...
                        <div class="media">
                            <img
                                ...
                                src="{{ asset('images/blog/fls1.jpg') }}"
                                alt="fls1.jpg"
                            >
                            <div class="media-body">
                        ...
                        <div class="media">
                            <img
                                class="align-self-start mr-3"
                                src="{{ asset('images/blog/fls2.jpg') }}"
                                alt="fls2.jpg"
                            >
                            <div class="media-body">
                        ...
                        <div class="media">
                            <img
                                class="align-self-start mr-3"
                                src="{{ asset('images/blog/fls3.jpg') }}"
                                alt="fls3.jpg"
                            >
                            <div class="media-body">
